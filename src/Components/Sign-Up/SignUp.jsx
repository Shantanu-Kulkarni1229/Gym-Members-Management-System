...
const SignUp = () => {
    return (
        <div className="customsignup w-1/3 p-10 mt-20 ml-20 bg-gray-500 bg-opacity-80 h-[450px] overflow-y-auto">
            ...
            <div className="p-2 w-[80%] border-w mb-10 bg-slate-800 mx-auto rounded-lg text-white text-center text-lg hover:bg-white hover:text-slate-800 font-semibold curson-pointer ">Forgot Password</div>
        </div>
    )
}
